            ...
            <div className="flex flex-col gap-10 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 text-white/70">
                  {/* Simple social icons as text placeholders */}
                  <button className="h-8 w-8 rounded-full border border-white/20 text-xs flex items-center justify-center hover:bg-white/10">
                    X
                  </button>
                  <button className="h-8 w-8 rounded-full border border-white/20 text-xs flex items-center justify-center hover:bg-white/10">
                    ▷
